...
-- AddForeignKey
ALTER TABLE "MembershipBranchAccess" ADD CONSTRAINT "MembershipBranchAccess_branchId_fkey" FOREIGN KEY ("branchId") REFERENCES "Branch"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
